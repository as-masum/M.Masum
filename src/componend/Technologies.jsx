...
// import {  BiLogoMysql } from "react-icons/bi";
import { FaHtml5, FaCss3Alt } from "react-icons/fa"; // FontAwesome Icons for HTML5 and CSS3
    ...
    <div className="border-b border-neutral-800 pb-24">
      ...
      className="flex flex-wrap items-center justify-center gap-4">
        ...
        <motion.div
          ...
          className="rounded-2xl border-4 border-neutral-800 p-4"
        >
          <FaJsSquare className="text-7xl text-center text-yellow-400" />
        ...
        >
          ...
          <h5 className="text-center">Reactjs</h5>
        </motion.div>

        {/* <div className="rounded-2xl border-4 border-neutral-800 p-4">
          <BiLogoMysql className="text-7xl text-cyan-400" />
          <h5 className="text-center">Reactjs</h5>
        </div> */}
        {/* <div className="rounded-2xl border-4 border-neutral-800 p-4">
          <DiRedis className="text-7xl text-red-400" />
          <h5 className="text-center">Redis</h5>
        </div>
        <div className="rounded-2xl border-4 border-neutral-800 p-4">
          <TbBrandNextjs className="text-7xl" />
          <h5 className="text-center">Nextjs</h5>
        </div> */}
      </motion.div>
    </div>
  );
